...
# określ indeksy (numer wiersza) w której znajduje się imie 1 z osób
# nazwę osoby podaje użytkownik
# ile osób o imieniu wskazanym przez użytkownika znajduje się na liście

# name = input('Podaj imie: Ala')
# list_name = ['Ala', 'Ola', 'Ola', 'Tomek']
# id = list_name.index(name)
# print('Pierwsza osoba o imieniu {} ma index: {}'.format(name, id))
# number_person = list_name.count(name)
# print('Liczba osób o imieniu', name, 'wynosi', number_person)
...
# dane_osobowe = {
#   'imie':['Ala','Tola'],
#   'nazwisko':['Kowalska','Nowak','Dziobuś']
# }

# id = 0
# id = int(input('Podaj index od 0 do 2: '))
# fname = dane_osobowe['imie'][id]
# sname = dane_osobowe['nazwisko'][id]
# print('imie {} nazwisko {}'.format(fname, sname))
